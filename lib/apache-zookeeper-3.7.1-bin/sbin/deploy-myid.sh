...
sudo docker exec master02 mkdir /usr/local/lib/apache-zookeeper-3.7.1-bin/data
sudo docker exec slave01 mkdir /usr/local/lib/apache-zookeeper-3.7.1-bin/data
